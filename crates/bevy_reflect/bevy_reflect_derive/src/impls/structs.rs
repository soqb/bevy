...
pub(crate) fn impl_struct(reflect_struct: &ReflectStruct) -> TokenStream {
    ...
    TokenStream::from(quote! {
        ...
        impl #impl_generics #bevy_reflect_path::PartialReflect for #struct_name #ty_generics #where_clause {
            #[inline]
            ...
            fn apply(&mut self, value: &dyn #bevy_reflect_path::PartialReflect) {
                if let #bevy_reflect_path::ReflectRef::Struct(struct_value) = #bevy_reflect_path::PartialReflect::reflect_ref(value) {
